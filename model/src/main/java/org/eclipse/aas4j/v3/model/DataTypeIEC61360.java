...
public enum DataTypeIEC61360 {
    ...
    /**
     */
    @IRI("https://admin-shell.io/DataSpecificationTemplates/DataSpecificationIEC61360/3/0/RC02/INTEGER_COUNT")
    INTEGER_COUNT,

    /**
     */
    @IRI("https://admin-shell.io/DataSpecificationTemplates/DataSpecificationIEC61360/3/0/RC02/INTEGER_CURRENCY")
    INTEGER_CURRENCY,

    /**
     */
    @IRI("https://admin-shell.io/DataSpecificationTemplates/DataSpecificationIEC61360/3/0/RC02/INTEGER_MEASURE")
    INTEGER_MEASURE,
    ...
    /**
     */
    @IRI("https://admin-shell.io/DataSpecificationTemplates/DataSpecificationIEC61360/3/0/RC02/RATIONAL_MEASURE")
    RATIONAL_MEASURE,

    /**
     */
    @IRI("https://admin-shell.io/DataSpecificationTemplates/DataSpecificationIEC61360/3/0/RC02/REAL_COUNT")
    REAL_COUNT,

    /**
     */
    @IRI("https://admin-shell.io/DataSpecificationTemplates/DataSpecificationIEC61360/3/0/RC02/REAL_MEASURE")
    REAL_MEASURE,
    ...
    /**
     */
    @IRI("https://admin-shell.io/DataSpecificationTemplates/DataSpecificationIEC61360/3/0/RC02/STRING_TRANSLATABLE")
    STRING_TRANSLATABLE,
