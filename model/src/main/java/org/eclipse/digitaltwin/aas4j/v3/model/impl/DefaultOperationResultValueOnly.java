...
public class DefaultOperationResultValueOnly implements OperationResultValueOnly {
    ...
    @Override
    public ValueOnly getInoutputArguments() {
        return inoutputArguments;
    }

    @Override
    public void setInoutputArguments(ValueOnly inoutputArguments) {
        this.inoutputArguments = inoutputArguments;
    }

    @Override
    public ValueOnly getOutputArguments() {
        return outputArguments;
    }

    @Override
    public void setOutputArguments(ValueOnly outputArguments) {
