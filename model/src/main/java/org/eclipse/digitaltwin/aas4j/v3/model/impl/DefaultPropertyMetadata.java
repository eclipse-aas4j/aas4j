...
import org.eclipse.digitaltwin.aas4j.v3.model.PropertyMetadata;
import org.eclipse.digitaltwin.aas4j.v3.model.Qualifier;
import org.eclipse.digitaltwin.aas4j.v3.model.Reference;
import org.eclipse.digitaltwin.aas4j.v3.model.annotations.IRI;
import org.eclipse.digitaltwin.aas4j.v3.model.builder.PropertyMetadataBuilder;
...
/**
 * Default implementation of package org.eclipse.digitaltwin.aas4j.v3.model.PropertyMetadata
 * 
 */

@IRI("aas:PropertyMetadata")
public class DefaultPropertyMetadata implements PropertyMetadata {
    ...
    @IRI("https://admin-shell.io/aas/3/0/PropertyMetadata/valueType")
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            DefaultPropertyMetadata other = (DefaultPropertyMetadata) obj;
    ...
    public String toString() {
        return String.format(
            "DefaultPropertyMetadata (" + "valueType=%s,"
                + ")",
            this.valueType);
    }

    /**
     * This builder class can be used to construct a DefaultPropertyMetadata bean.
     */
    public static class Builder extends PropertyMetadataBuilder<DefaultPropertyMetadata, Builder> {
        ...
        @Override
        protected DefaultPropertyMetadata newBuildingInstance() {
