...
public class DefaultAnnotatedRelationshipElementValue implements AnnotatedRelationshipElementValue {
    ...
    protected ValueOnly annotations;
    ...
    public String toString() {
        return "DefaultAnnotatedRelationshipElementValue{" +
    ...
    @Override
    public ValueOnly getAnnotations() {
        return annotations;
    }

    @Override
    public void setAnnotations(ValueOnly annotations) {
