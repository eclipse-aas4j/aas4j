...
@KnownSubtypes({@KnownSubtypes.Type(value = DefaultBasicEventElement.class)})
public interface BasicEventElement extends EventElement {
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/BasicEventElement/observed
   *
   ...
   * Direction of event.
   *
   * <p>More information under https://admin-shell.io/aas/3/2/BasicEventElement/direction
   *
   ...
   * State of event.
   *
   * <p>More information under https://admin-shell.io/aas/3/2/BasicEventElement/state
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/BasicEventElement/messageTopic
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/BasicEventElement/messageBroker
   *
   ...
   * direction).
   *
   * <p>More information under https://admin-shell.io/aas/3/2/BasicEventElement/lastUpdate
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/BasicEventElement/minInterval
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/BasicEventElement/maxInterval
   *
