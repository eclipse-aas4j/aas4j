 ...
 *
 * <p>A 'Blob' is a data element that represents a file that is contained with its source code in
 * the value attribute.
 */
@IRI("aas:Blob")
public class DefaultBlob implements Blob {
  ...
  public String toString() {
    return String.format(
        "DefaultBlob (" + "value=%s," + "contentType=%s," + ")", this.value, this.contentType);
  }
