...
public @interface KnownSubtypes {
  /**
   * This element stores the known sub-types, e.g. implementing classes of an interface, or
   * extending classes of a class. Note that this list can never be expected to be complete, as
   * custom implementations will not be included.
   *
