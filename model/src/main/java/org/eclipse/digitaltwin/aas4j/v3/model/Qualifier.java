 ...
 * element.
 */
@KnownSubtypes({@KnownSubtypes.Type(value = DefaultQualifier.class)})
public interface Qualifier extends HasSemantics {
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Qualifier/kind
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Qualifier/type
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Qualifier/valueType
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Qualifier/value
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Qualifier/valueId
   *
