...
import org.eclipse.digitaltwin.aas4j.v3.model.RangeValue;

import java.math.BigInteger;


public abstract class RangeValueBuilder<T extends RangeValue, B extends RangeValueBuilder<T, B>> extends ExtendableBuilder<T, B> {
