...
public interface Entity extends SubmodelElement {
   ...
   * qualified value.
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Entity/statements
   *
   ...
   *
   * @param statement desired value to be added to the property statements.
   */
  void setStatement(SubmodelElement statement);

  /**
   * Describes whether the entity is a co-managed entity or a self-managed entity.
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Entity/entityType
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Entity/globalAssetId
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Entity/specificAssetIds
   *
   ...
   *
   * @param specificAssetId desired value to be added to the property specificAssetIds.
   */
