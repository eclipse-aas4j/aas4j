...
public interface EventPayload {
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/EventPayload/source
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/EventPayload/sourceSemanticId
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/EventPayload/observableReference
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/EventPayload/observableSemanticId
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/EventPayload/topic
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/EventPayload/subjectId
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/EventPayload/timeStamp
   *
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/EventPayload/payload
   *
