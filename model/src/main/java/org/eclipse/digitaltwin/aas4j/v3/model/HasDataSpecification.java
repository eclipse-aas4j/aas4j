...
public interface HasDataSpecification {
   ...
   * https://admin-shell.io/aas/3/2/HasDataSpecification/embeddedDataSpecifications
   *
   * @param embeddedDataSpecification desired value to be added to the property
   *     embeddedDataSpecifications.
   */
  void setEmbeddedDataSpecification(EmbeddedDataSpecification embeddedDataSpecification);
}
