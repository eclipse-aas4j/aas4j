...
public interface OperationResult {
   ...
   *
   * @return Returns the List of Results for the property executionResults.
   */
  @IRI("https://admin-shell.io/aas/3/2/OperationResult/executionResult")
  List<Result> getExecutionResults();

  /**
   * More information under https://admin-shell.io/aas/3/2/OperationResult/executionResult
   *
   * @param executionResults desired value for the property executionResults.
   */
  void setExecutionResults(List<Result> executionResults);

  /**
   * More information under https://admin-shell.io/aas/3/2/OperationResult/executionState
   *
   * @return Returns the List of ExecutionStates for the property executionStates.
   */
  @IRI("https://admin-shell.io/aas/3/2/OperationResult/executionState")
  List<ExecutionState> getExecutionStates();

  /**
   * More information under https://admin-shell.io/aas/3/2/OperationResult/executionState
   *
   * @param executionStates desired value for the property executionStates.
   */
  void setExecutionStates(List<ExecutionState> executionStates);
   ...
   *
   * @return Returns the List of Strings for the property requestIds.
   */
   ...
   * More information under https://admin-shell.io/aas/3/2/OperationResult/requestId
   *
   * @param requestIds desired value for the property requestIds.
   */
  void setRequestIds(List<String> requestIds);
}
