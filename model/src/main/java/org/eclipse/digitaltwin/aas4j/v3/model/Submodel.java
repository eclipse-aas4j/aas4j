...
public interface Submodel
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Submodel/submodelElements
   *
   ...
   *
   * @param submodelElement desired value to be added to the property submodelElements.
   */
  void setSubmodelElement(SubmodelElement submodelElement);
}
