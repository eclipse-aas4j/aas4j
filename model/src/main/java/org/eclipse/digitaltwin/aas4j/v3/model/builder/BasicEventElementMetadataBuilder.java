...
public abstract class BasicEventElementMetadataBuilder<T extends BasicEventElementMetadata, B extends BasicEventElementMetadataBuilder<T, B>>
    ...
    /**
     * This function allows setting a value for directions
     * 
     * @param directions desired value to be set
     * @return Builder object with new value for directions
     */
    public B directions(List<Direction> directions) {
        getBuildingInstance().setDirections(directions);
        return getSelf();
    }

    /**
     * This function allows adding a value to the List directions
     * 
     * @param direction desired value to be added
     * @return Builder object with new value for directions
     */
    public B direction(Direction direction) {
        getBuildingInstance().getDirections().add(direction);
        return getSelf();
    }

    /**
     * This function allows setting a value for states
     * 
     * @param states desired value to be set
     * @return Builder object with new value for states
     */
    public B states(List<StateOfEvent> states) {
        getBuildingInstance().setStates(states);
        return getSelf();
    }

    /**
     * This function allows adding a value to the List states
     * 
     * @param state desired value to be added
     * @return Builder object with new value for states
     */
    public B state(StateOfEvent state) {
        getBuildingInstance().getStates().add(state);
        return getSelf();
    }

    /**
     * This function allows setting a value for messageBrokers
     * 
     * @param messageBrokers desired value to be set
     * @return Builder object with new value for messageBrokers
     */
    public B messageBrokers(List<Reference> messageBrokers) {
        getBuildingInstance().setMessageBrokers(messageBrokers);
        return getSelf();
    }

    /**
     * This function allows adding a value to the List messageBrokers
     * 
     * @param messageBroker desired value to be added
     * @return Builder object with new value for messageBrokers
     */
    public B messageBroker(Reference messageBroker) {
        getBuildingInstance().getMessageBrokers().add(messageBroker);
        return getSelf();
    }

    /**
     * This function allows setting a value for messageTopics
     * 
     * @param messageTopics desired value to be set
     * @return Builder object with new value for messageTopics
     */
    public B messageTopics(List<String> messageTopics) {
        getBuildingInstance().setMessageTopics(messageTopics);
        return getSelf();
    }

    /**
     * This function allows adding a value to the List messageTopics
     * 
     * @param messageTopic desired value to be added
     * @return Builder object with new value for messageTopics
     */
    public B messageTopic(String messageTopic) {
        getBuildingInstance().getMessageTopics().add(messageTopic);
        return getSelf();
    }

    /**
     * This function allows setting a value for lastUpdates
     * 
     * @param lastUpdates desired value to be set
     * @return Builder object with new value for lastUpdates
     */
    public B lastUpdates(List<String> lastUpdates) {
        getBuildingInstance().setLastUpdates(lastUpdates);
        return getSelf();
    }

    /**
     * This function allows adding a value to the List lastUpdates
     * 
     * @param lastUpdate desired value to be added
     * @return Builder object with new value for lastUpdates
     */
    public B lastUpdate(String lastUpdate) {
        getBuildingInstance().getLastUpdates().add(lastUpdate);
        return getSelf();
    }

    /**
     * This function allows setting a value for minIntervals
     * 
     * @param minIntervals desired value to be set
     * @return Builder object with new value for minIntervals
     */
    public B minIntervals(List<String> minIntervals) {
        getBuildingInstance().setMinIntervals(minIntervals);
        return getSelf();
    }

    /**
     * This function allows adding a value to the List minIntervals
     * 
     * @param minInterval desired value to be added
     * @return Builder object with new value for minIntervals
     */
    public B minInterval(String minInterval) {
        getBuildingInstance().getMinIntervals().add(minInterval);
        return getSelf();
    }

    /**
     * This function allows setting a value for maxIntervals
     * 
     * @param maxIntervals desired value to be set
     * @return Builder object with new value for maxIntervals
     */
    public B maxIntervals(List<String> maxIntervals) {
        getBuildingInstance().setMaxIntervals(maxIntervals);
        return getSelf();
    }

    /**
     * This function allows adding a value to the List maxIntervals
     * 
     * @param maxInterval desired value to be added
     * @return Builder object with new value for maxIntervals
     */
    public B maxInterval(String maxInterval) {
        getBuildingInstance().getMaxIntervals().add(maxInterval);
        return getSelf();
    }
