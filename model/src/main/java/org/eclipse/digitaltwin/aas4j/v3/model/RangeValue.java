...
public interface RangeValue {
    ...
    /**
     *
     * More information under https://admin-shell.io/aas/3/1/RangeValue/max
     *
     * @return Returns the BigInteger for the property max.
     */
    @IRI("https://admin-shell.io/aas/3/1/RangeValue/max")
    BigInteger getMax();
    ...
    /**
     *
     * More information under https://admin-shell.io/aas/3/1/RangeValue/min
     *
     * @return Returns the BigInteger for the property min.
     */
    @IRI("https://admin-shell.io/aas/3/1/RangeValue/min")
    BigInteger getMin();
