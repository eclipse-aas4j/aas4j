 ...
 * org.eclipse.digitaltwin.aas4j.v3.model.SubmodelElementListMetadata
 * 
 */

@IRI("aas:SubmodelElementListMetadata")
public class DefaultSubmodelElementListMetadata implements SubmodelElementListMetadata {
    ...
    @IRI("https://admin-shell.io/aas/3/1/SubmodelElementListMetadata/orderRelevant")
    protected boolean orderRelevant;

    @IRI("https://admin-shell.io/aas/3/1/SubmodelElementListMetadata/semanticIdListElement")
    protected Reference semanticIdListElement;

    @IRI("https://admin-shell.io/aas/3/1/SubmodelElementListMetadata/typeValueListElement")
    protected ModelType typeValueListElement;

    @IRI("https://admin-shell.io/aas/3/1/SubmodelElementListMetadata/valueTypeListElement")
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            DefaultSubmodelElementListMetadata other = (DefaultSubmodelElementListMetadata) obj;
    ...
    /**
     * This builder class can be used to construct a DefaultSubmodelElementListMetadata bean.
     */
    public static class Builder extends SubmodelElementListMetadataBuilder<DefaultSubmodelElementListMetadata, Builder> {
        ...
        @Override
        protected DefaultSubmodelElementListMetadata newBuildingInstance() {
            return new DefaultSubmodelElementListMetadata();
        }
    }
}
