...
import org.eclipse.digitaltwin.aas4j.v3.model.SubmodelElementListMetadata;
import org.eclipse.digitaltwin.aas4j.v3.model.annotations.IRI;
import org.eclipse.digitaltwin.aas4j.v3.model.builder.SubmodelElementListMetadataBuilder;
...
public class DefaultSubmodelElementListMetadata implements SubmodelElementListMetadata {
    ...
    public String toString() {
        return String.format(
            "DefaultSubmodelElementListMetadata (" + "orderRelevant=%s,"
                + "semanticIdListElement=%s,"
                + "typeValueListElement=%s,"
                + "valueTypeListElement=%s,"
                + ")",
            this.orderRelevant, this.semanticIdListElement, this.typeValueListElement, this.valueTypeListElement);
    }
