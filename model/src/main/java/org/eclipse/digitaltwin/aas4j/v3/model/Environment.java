...
public interface Environment {
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Environment/assetAdministrationShells
   *
   ...
   *     assetAdministrationShells.
   */
  void setAssetAdministrationShell(AssetAdministrationShell assetAdministrationShell);

  /**
   * Concept description
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Environment/conceptDescriptions
   *
   ...
   *
   * @param conceptDescription desired value to be added to the property conceptDescriptions.
   */
   ...
   * Submodel
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Environment/submodels
   *
   ...
   *
   * @param submodel desired value to be added to the property submodels.
   */
