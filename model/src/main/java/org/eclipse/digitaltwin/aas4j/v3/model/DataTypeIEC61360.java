...
public enum DataTypeIEC61360 {
     ...
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/Blob")
    BLOB,

    /**
     * values representing truth of logic or Boolean algebra (TRUE, FALSE)
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/Boolean")
    BOOLEAN,
     ...
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/Date")
    DATE,
     ...
     * or relative path.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/File")
    FILE,
     ...
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/Html")
    HTML,

    /**
     * values containing values of type INTEGER but are no currencies or measures
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/IntegerCount")
    INTEGER_COUNT,

    /**
     * values containing values of type INTEGER that are currencies
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/IntegerCurrency")
    INTEGER_CURRENCY,
     ...
     * physical unit.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/IntegerMeasure")
    INTEGER_MEASURE,

    /**
     * values conforming to ISO/IEC 11179 series global identifier sequences
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/Irdi")
    IRDI,

    /**
     * values containing values of type STRING conformant to Rfc 3987
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/Iri")
    IRI,

    /**
     * values containing values of type rational
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/Rational")
    RATIONAL,

    /**
     * values containing values of type rational. In addition such a value comes with a physical unit.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/RationalMeasure")
    RATIONAL_MEASURE,
     ...
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/RealCount")
    REAL_COUNT,

    /**
     * values containing values of type REAL that are currencies
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/RealCurrency")
    REAL_CURRENCY,
     ...
     * physical unit.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/RealMeasure")
    REAL_MEASURE,

    /**
     * values consisting of sequence of characters but cannot be translated into other languages
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/String")
    STRING,

    /**
     * values containing string but shall be represented as different string in different languages
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/StringTranslatable")
    STRING_TRANSLATABLE,
     ...
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/Time")
    TIME,
     ...
     * corresponding type in xml.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/DataTypeIEC61360/Timestamp")
    TIMESTAMP;
