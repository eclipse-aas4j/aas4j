...
public abstract class SubmodelElementListMetadataBuilder<T extends SubmodelElementListMetadata, B extends SubmodelElementListMetadataBuilder<T, B>>
     ...
     */
    public B typeValueListElement(ModelType typeValueListElement) {
