...
public interface Operation extends SubmodelElement {
   ...
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Operation/inputVariables
   *
   ...
   *
   * @param inputVariable desired value to be added to the property inputVariables.
   */
  void setInputVariable(OperationVariable inputVariable);

  /**
   * Output parameter of the operation.
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Operation/outputVariables
   *
   ...
   *
   * @param outputVariable desired value to be added to the property outputVariables.
   */
  void setOutputVariable(OperationVariable outputVariable);

  /**
   * Parameter that is input and output of the operation.
   *
   * <p>More information under https://admin-shell.io/aas/3/2/Operation/inoutputVariables
   *
   ...
   *
   * @param inoutputVariable desired value to be added to the property inoutputVariables.
   */
