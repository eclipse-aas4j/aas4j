...
public class DefaultProtocolInformation implements ProtocolInformation {
  ...
  public String toString() {
    return "DefaultProtocolInformation{"
        + "endpointAddress='"
        + endpointAddress
        + "',"
        + "endpointProtocol='"
  ...
  @Override
  public void setSecurityAttribute(SecurityAttributeObject securityAttribute) {
    this.securityAttributes.add(securityAttribute);
  }
