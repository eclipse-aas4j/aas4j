 ...
 * data elements.
 */
@KnownSubtypes({@KnownSubtypes.Type(value = DefaultAnnotatedRelationshipElement.class)})
public interface AnnotatedRelationshipElement extends RelationshipElement {
  ...
  /**
   * More information under https://admin-shell.io/aas/3/2/AnnotatedRelationshipElement/annotations
   *
   * @param annotation desired value to be added to the property annotations.
   */
  void setAnnotation(DataElement annotation);
}
