...
public class DefaultAssetAdministrationShellMetadata implements AssetAdministrationShellMetadata {
    ...
    @IRI("https://admin-shell.io/aas/3/1/AssetAdministrationShellMetadata/derivedFrom")
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.derivedFroms,
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            return Objects.equals(this.derivedFroms, other.derivedFroms) &&
    ...
    public String toString() {
        return "DefaultAssetAdministrationShellMetadata{" +
                "derivedFroms=" + derivedFroms +
