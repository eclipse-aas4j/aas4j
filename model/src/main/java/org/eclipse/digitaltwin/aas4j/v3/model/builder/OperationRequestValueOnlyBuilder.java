...
public abstract class OperationRequestValueOnlyBuilder<T extends OperationRequestValueOnly, B extends OperationRequestValueOnlyBuilder<T, B>>
     ...
     */
    public B inoutputArguments(List<ValueOnly> inoutputArguments) {
     ...
     * @return Builder object with new value for inoutputArguments
     */
    public B inoutputArguments(ValueOnly inoutputArguments) {
     ...
     */
    public B inputArguments(List<ValueOnly> inputArguments) {
     ...
     * @return Builder object with new value for inputArguments
     */
    public B inputArguments(ValueOnly inputArguments) {
