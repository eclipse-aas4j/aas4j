...
public class Examples {
  ...
  private static final EmbeddedDataSpecification DEFAULT_EMBEDDED_DATA_SPECIFICATION =
      new DefaultEmbeddedDataSpecification.Builder()
          .dataSpecificationContent(
              new DefaultDataSpecificationIec61360.Builder()
                  ...
                  .build())
          .dataSpecification(
              createGlobalReference("defaultEmbeddedDataSpecificationDataSpecificationValue"))
          .build();
  ...
  private static final List<LangStringTextType> DEFAULT_DESCRIPTION =
      List.of(createLangStringTextType("en", "defaultDescription"));

  private static final List<LangStringNameType> DEFAULT_DISPLAY_NAME =
      List.of(createLangStringNameType("en", "defaultDisplayName"));
  ...
  private static DefaultProtocolInformation.Builder createProtocolInformationBuilder() {
    return new DefaultProtocolInformation.Builder()
        ...
        .securityAttributes(
            new DefaultSecurityAttributeObject.Builder()
                .key("NONE")
  ...
  private static AssetAdministrationShellDescriptor createAasDescriptor() {
    ...
    return new DefaultAssetAdministrationShellDescriptor.Builder()
        ...
        .submodelDescriptors(List.of(createDefaultSubmodelDescriptor()))
        .build();
  }
    ...
    try {
      return new DefaultOperationRequest.Builder()
          ...
          .clientTimeoutDuration(
              DatatypeFactory.newInstance().newDurationDayTime("PT3M")) // three minutes
          .build();
  ...
  public static final ExampleData<Environment> EXAMPLE_FULL =
      ExampleData.of(AASFull.createEnvironment(), "Example-Full.json");

  public static final ExampleData<Environment> EXAMPLE_SIMPLE =
      ExampleData.of(AASSimple.createEnvironment(), "Example-Simple.json");

  public static final ExampleData<Environment> ENVIRONMENT_EMPTY =
      ExampleData.of(new DefaultEnvironment.Builder().build(), "Environment-Empty.json");

  public static final ExampleData<Environment> ENVIRONMENT_CUSTOM_DATA =
      ExampleData.of(
          org.eclipse.digitaltwin.aas4j.v3.dataformat.core.Examples.ENVIRONMENT_WITH_DUMMYDATASPEC,
          "Environment-CustomDataSpec.json");

  public static final ExampleData<AssetAdministrationShellDescriptor> SHELL_DESCRIPTOR =
      ExampleData.of(createAasDescriptor(), "AssetAdministrationShellDescriptor.json");

  public static final ExampleData<SubmodelDescriptor> SUBMODEL_DESCRIPTOR =
      ExampleData.of(createDefaultSubmodelDescriptor(), "SubmodelDescriptor.json");

  public static final ExampleData<List<AssetAdministrationShell>>
      ASSET_ADMINISTRATION_SHELL_LIST_OF =
          ExampleData.of(
              List.of(
                  AASFull.createEnvironment().getAssetAdministrationShells().get(0),
                  AASFull.createEnvironment().getAssetAdministrationShells().get(1)),
              "AssetAdministrationShell-List.json");

  public static final ExampleData<AssetAdministrationShell>
      ASSET_ADMINISTRATION_SHELL_WITH_ASSET_INFORMATION =
          ExampleData.of(
  ...
  public static final ExampleData<AssetAdministrationShell> ASSET_ADMINISTRATION_SHELL =
      ExampleData.of(
          AASFull.createEnvironment().getAssetAdministrationShells().get(0),
          "AssetAdministrationShell.json");

  public static final ExampleData<ConceptDescription>
      CONCEPT_DESCRIPTION_DATA_SPECIFICATION_PHYSICAL_UNIT =
          ExampleData.of(
  ...
  public static final ExampleData<List<SubmodelElement>> SUBMODEL_ELEMENT_LIST_OF =
      ExampleData.of(
          List.of(
              AASFull.createEnvironment().getSubmodels().get(0).getSubmodelElements().get(0),
              AASFull.createEnvironment().getSubmodels().get(0).getSubmodelElements().get(1)),
          "SubmodelElement-List.json");

  public static final ExampleData<List<Submodel>> SUBMODEL_LIST_OF =
      ExampleData.of(
          List.of(
              AASFull.createEnvironment().getSubmodels().get(0),
              AASFull.createEnvironment().getSubmodels().get(1)),
          "Submodel-List.json");

  public static final ExampleData<Submodel> SUBMODEL =
      ExampleData.of(AASFull.createEnvironment().getSubmodels().get(0), "Submodel.json");

  public static final ExampleData<SubmodelElement> SUBMODEL_ELEMENT =
      ExampleData.of(
          AASFull.createEnvironment().getSubmodels().get(0).getSubmodelElements().get(0),
          "SubmodelElement.json");

  public static final ExampleData<SubmodelElementCollection> SUBMODEL_ELEMENT_COLLECTION =
      ExampleData.of(
          (SubmodelElementCollection)
              AASFull.createEnvironment().getSubmodels().get(6).getSubmodelElements().get(6),
          "SubmodelElementCollection.json");

  public static final ExampleData<SubmodelElementList> SUBMODEL_ELEMENT_LIST_EMPTY =
      ExampleData.of(
          new DefaultSubmodelElementList.Builder()
              .idShort("submodelElementList")
              .orderRelevant(true)
              .build(),
          "SubmodelElementList-Empty.json");

  public static final ExampleData<SubmodelElementList> SUBMODEL_ELEMENT_LIST =
      ExampleData.of(
          (SubmodelElementList)
              AASFull.createEnvironment().getSubmodels().get(6).getSubmodelElements().get(5),
          "SubmodelElementList.json");

  public static final ExampleData<Environment> EXTENSION_MINIMAL =
      ExampleData.of(
          org.eclipse.digitaltwin.aas4j.v3.dataformat.core.Examples.EXTENSION_MINIMAL,
          "admin-shell-io/Extension/Minimal.json");

  public static final ExampleData<Environment> EXTENSION_MAXIMAL =
      ExampleData.of(
          org.eclipse.digitaltwin.aas4j.v3.dataformat.core.Examples.EXTENSION_MAXIMAL,
          "admin-shell-io/Extension/Maximal.json");

  public static final ExampleData<OperationRequest> OPERATION_REQUEST =
      ExampleData.of(createOperationRequest(), "OperationRequest.json");
}
