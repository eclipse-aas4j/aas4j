 ...
 * @author bader, chang
 *
 * note: As SubjectAttributes are not part of the metamodel anymore, this test does not make sense anymore.
 *
 */
...
/*
	...
	public void noRelation() throws ValidationException {
		...
		reference.getKeys().get(0).setType(KeyTypes.PROPERTY);
