...
public class ReferenceElementMapper extends ReferableMapper<ReferenceElement> {
    ...
    protected static PropertyDescriptor PROPERTY_VALUE = AasUtils.getProperty(ReferenceElement.class, "value");
    ...
    protected Object fromInternalElement(AmlParser parser, InternalElementType internalElement, MappingContext context) throws MappingException {
        ...
        parser.resolveIdToReferenceLater(result, PROPERTY_VALUE, findInternalLinkTarget(internalElement, PROPERTY_VALUE));
        return result;
    }
}
