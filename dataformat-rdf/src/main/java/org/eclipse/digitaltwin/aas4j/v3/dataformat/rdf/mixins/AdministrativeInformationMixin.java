...
public interface AdministrativeInformationMixin extends HasDataSpecificationMixin {
    @JsonProperty("https://admin-shell.io/aas/3/0/AdministrativeInformation/version")
    String getVersion();

    @JsonProperty("https://admin-shell.io/aas/3/0/AdministrativeInformation/version")
    void setVersion(String version);

    @JsonProperty("https://admin-shell.io/aas/3/0/AdministrativeInformation/revision")
    String getRevision();
