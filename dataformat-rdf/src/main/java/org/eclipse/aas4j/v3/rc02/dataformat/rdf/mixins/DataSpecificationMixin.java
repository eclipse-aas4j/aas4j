...
@JsonTypeName("https://admin-shell.io/aas/3/0/RC01/DataSpecification")
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "@type")
public interface DataSpecificationMixin {
    @JsonProperty("https://admin-shell.io/aas/3/0/RC01/DataSpecification/dataSpecificationContent")
