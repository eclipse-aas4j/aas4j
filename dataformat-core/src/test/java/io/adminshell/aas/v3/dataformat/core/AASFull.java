    ...
    public static Submodel createSubmodel3() {
        return new DefaultSubmodel.Builder()
                ...
                .submodelElements(new DefaultRelationshipElement.Builder()
                        ...
                        .first(new DefaultReference.Builder()
                                ...
                                .keys(new DefaultKey.Builder()
                                        ...
                                        .value("ExampleSubmodelCollectionorderRelevant")
                ...
                .submodelElements(new DefaultSubmodelElementList.Builder()
                        .idShort("ExampleSubmodelCollectionorderRelevant")
                        .category("Parameter")
                        .description(new DefaultLangStringSet.Builder()
                                .langStrings(new DefaultLangString.Builder().text("Example SubmodelElementCollectionorderRelevant object").language("en-us").build())
                                .langStrings(new DefaultLangString.Builder().text("Beispiel SubmodelElementCollectionorderRelevant Element").language("de").build())
                                .build())
                        .semanticId(new DefaultReference.Builder()
                                .keys(new DefaultKey.Builder()
                                        .type(KeyTypes.GLOBAL_REFERENCE)
                                        .value("http://acplt.org/SubmodelElementCollections/ExampleSubmodelElementCollectionorderRelevant")
                        ...
                        .value(new DefaultMultiLanguageProperty.Builder()
                                ...
                                .semanticId(new DefaultReference.Builder()
                                        ...
                                        .build())
                                .description(new DefaultLangStringSet.Builder()
                                        .langStrings(new DefaultLangString.Builder().text("Example value MultiLanguageProperty object").language("en-us").build())
                                        .langStrings(new DefaultLangString.Builder().text("Beispielswert MultiLanguageProperty-Element").language("de").build())
                                        .build())
                                .valueId(new DefaultReference.Builder()
                                        .keys(new DefaultKey.Builder()
                                                .type(KeyTypes.GLOBAL_REFERENCE)
                        ...
                        .build())
                .submodelElements(new DefaultSubmodelElementList.Builder()
                        .idShort("ExampleSubmodelCollectionUnorderRelevant")
                        .category("Parameter")
                        .description(new DefaultLangStringSet.Builder()
                                .langStrings(new DefaultLangString.Builder().text("Example SubmodelElementCollectionUnorderRelevant object").language("en-us").build())
                                .langStrings(new DefaultLangString.Builder().text("Beispiel SubmodelElementCollectionUnorderRelevant Element").language("de").build())
                                .build())
                        .semanticId(new DefaultReference.Builder()
                                .keys(new DefaultKey.Builder()
                                        .type(KeyTypes.GLOBAL_REFERENCE)
                                        .value("http://acplt.org/SubmodelElementCollections/ExampleSubmodelElementCollectionUnorderRelevant")
    ...
    public static Submodel createSubmodel4() {
        return new DefaultSubmodel.Builder()
                ...
                .submodelElements(new DefaultSubmodelElementList.Builder()
                        ...
                        .build())
                .submodelElements(new DefaultSubmodelElementList.Builder()
                        .idShort("ExampleSubmodelCollectionUnorderRelevant2")
                        .orderRelevant(false)
                        .build())
                .build();
    }
        ...
        return new DefaultSubmodel.Builder()
                ...
                .submodelElements(new DefaultRelationshipElement.Builder()
                        ...
                        .second(new DefaultReference.Builder()
                                ...
                                .build())
                        .build())
                .submodelElements(new DefaultAnnotatedRelationshipElement.Builder().idShort("ExampleAnnotatedRelationshipElement")
                        .category("Parameter")
                        .description(new DefaultLangStringSet.Builder()
                                .langStrings(new DefaultLangString.Builder().text("Example AnnotatedRelationshipElement object").language("en-us").build())
                                .langStrings(new DefaultLangString.Builder().text("Beispiel AnnotatedRelationshipElement Element").language("de").build())
