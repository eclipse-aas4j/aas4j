    ...
    public static Submodel createSubmodel3() {
        return new DefaultSubmodel.Builder()
                ...
                .submodelElements(new DefaultBasicEventElement.Builder()
                        ...
                        .observed(new DefaultReference.Builder()
                                ...
                                .keys(new DefaultKey.Builder()
                                        ...
                                        .value("ExampleSubmodelListOrdered")
                                        .build())
                                .keys(new DefaultKey.Builder()
                                        .type(KeyTypes.PROPERTY)
                                        .value("ExampleProperty")
                ...
                .submodelElements(new DefaultSubmodelElementList.Builder()
                        .idShort("ExampleSubmodelListOrdered")
                        .category("Parameter")
                        .orderRelevant(true)
                        .descriptions(Arrays.asList(
                                new DefaultLangString.Builder().text("Example ExampleSubmodelListOrdered object").language("en-us").build(),
                                new DefaultLangString.Builder().text("Beispiel ExampleSubmodelListOrdered Element").language("de").build()
                                ))
                        .semanticId(new DefaultReference.Builder()
                                .keys(new DefaultKey.Builder()
                                        .type(KeyTypes.GLOBAL_REFERENCE)
    ...
    public static Submodel createSubmodel4() {
        return new DefaultSubmodel.Builder()
                ...
                .submodelElements(new DefaultBasicEventElement.Builder()
                        ...
                        .build())
                .submodelElements(new DefaultSubmodelElementList.Builder()
                        .idShort("ExampleSubmodelListUnordered")
                        .orderRelevant(false)
                        .value(new DefaultProperty.Builder()
                                .idShort("ExampleProperty")
                                .value(null)
