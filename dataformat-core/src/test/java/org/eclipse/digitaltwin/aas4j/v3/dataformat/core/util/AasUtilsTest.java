...
public class AasUtilsTest {
  ...
  public void whenResolve_withProperty_success() {
    ...
    SubmodelElement expected =
        new DefaultProperty.Builder().idShort(submodelElementIdShort).value("bar").build();
    Environment environment =
        new DefaultEnvironment.Builder()
            .submodels(
                new DefaultSubmodel.Builder().id(submodelId).submodelElements(expected).build())
            .build();
    Reference reference =
  ...
  public void whenResolve_insideSubmodelElementList_success() {
    ...
    Environment environment =
        new DefaultEnvironment.Builder()
            .submodels(new DefaultSubmodel.Builder().id(submodelId).submodelElements(list).build())
            .build();
    Reference reference =
        new DefaultReference.Builder()
            .keys(new DefaultKey.Builder().type(KeyTypes.SUBMODEL).value(submodelId).build())
            .keys(
                new DefaultKey.Builder()
                    ...
                    .build())
            .keys(new DefaultKey.Builder().type(KeyTypes.SUBMODEL_ELEMENT).value("0").build())
            .build();
    Referable actual = AasUtils.resolve(reference, environment);
    Assert.assertEquals(expected, actual);
  }
        ...
        new DefaultReference.Builder()
            ...
            .keys(
                new DefaultKey.Builder()
                    ...
                    .value(submodelElementListIdShort)
                    .build())
            .keys(new DefaultKey.Builder().type(KeyTypes.SUBMODEL_ELEMENT).value("1").build())
            .build();
  ...
  public void whenResolve_insideSubmodelElementCollection_success() {
    ...
    SubmodelElement expected =
        new DefaultProperty.Builder().idShort(submodelElementIdShort).value("bar").build();
    SubmodelElementCollection list =
  ...
  public void whenResolve_withElementWithinSubmodelElementList_success() {
    String submodelId = "http://example.org/submodel";
    String submodelElementIdShort = "foo";
    SubmodelElement expected = new DefaultProperty.Builder().value("bar").build();
    Environment environment =
        new DefaultEnvironment.Builder()
            .submodels(
  ...
  public void whenSameAs_withDifferentKeyTypesButSameValues_success() {
    ...
    Reference ref1 =
        new DefaultReference.Builder()
            .keys(new DefaultKey.Builder().type(KeyTypes.GLOBAL_REFERENCE).value(value).build())
            .build();
    Reference ref2 =
        new DefaultReference.Builder()
            .keys(new DefaultKey.Builder().type(KeyTypes.FRAGMENT_REFERENCE).value(value).build())
            .build();
  ...
  public void whenSameAs_withoutKeysAndDifferentSemaniticIDs_fail() {
    Reference semanticId1 =
        new DefaultReference.Builder()
            .keys(new DefaultKey.Builder().value("value1").build())
            .build();
    Reference semanticId2 =
        new DefaultReference.Builder()
            .keys(
                new DefaultKey.Builder().type(KeyTypes.FRAGMENT_REFERENCE).value("value2").build())
            .build();
    Reference ref1 = new DefaultReference.Builder().referredSemanticId(semanticId1).build();
    ref1.setKeys(null);
    Reference ref2 = new DefaultReference.Builder().referredSemanticId(semanticId2).build();
    ref2.setKeys(new ArrayList<>());
  ...
  public void whenSameAs_withDifferentKeyTypesAndValues_fail() {
    Reference ref1 =
        new DefaultReference.Builder()
            .keys(new DefaultKey.Builder().type(KeyTypes.GLOBAL_REFERENCE).value("foo").build())
            .build();
    Reference ref2 =
        new DefaultReference.Builder()
            .keys(new DefaultKey.Builder().type(KeyTypes.FRAGMENT_REFERENCE).value("bar").build())
            .build();
    Assert.assertFalse(AasUtils.sameAs(ref1, ref2));
  }
  ...
  public void whenSameAs_withSameKeyTypesButDifferentValues_fail() {
    ...
    Reference ref2 =
        new DefaultReference.Builder()
            .keys(new DefaultKey.Builder().type(KeyTypes.GLOBAL_REFERENCE).value("bar").build())
            .build();
    Assert.assertFalse(AasUtils.sameAs(ref1, ref2));
  }
  ...
  public void whenAsString_withSubmodelElementList_success() {
    Reference reference =
        new DefaultReference.Builder()
            .type(ReferenceTypes.MODEL_REFERENCE)
            .keys(new DefaultKey.Builder().type(KeyTypes.SUBMODEL).value("submodel").build())
            .keys(
                new DefaultKey.Builder().type(KeyTypes.SUBMODEL_ELEMENT_LIST).value("list").build())
            .keys(new DefaultKey.Builder().type(KeyTypes.PROPERTY).value("0").build())
            .build();
  ...
  public void whenAsString_withReferredSemanticId_success() {
    ...
    Reference reference =
        new DefaultReference.Builder()
            ...
            .build();
    String expected =
        "[ExternalRef- [ModelRef](GlobalReference)foo -](GlobalReference)0173-1#01-ADS698#010";
    String actual = AasUtils.asString(reference);
    Assert.assertEquals(expected, actual);
  }
