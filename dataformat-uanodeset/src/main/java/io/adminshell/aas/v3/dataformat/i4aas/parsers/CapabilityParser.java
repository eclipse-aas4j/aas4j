...
public class CapabilityParser extends ReferableParser<Capability> {

	public CapabilityParser(UANodeWrapper src, ParserContext ctx) {
		super(src, ctx);
	}

	@Override
	protected Capability createTargetObject() {
