...
/**
 * <p>Java-Klasse für FieldMetaData complex type.
 * 
...
public class FieldMetaData {
    ...
    /**
     * Ruft den Wert der fieldFlags-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link Integer }
    ...
    /**
     * Legt den Wert der fieldFlags-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link Integer }
     ...
     */
    public<_B >void copyTo(final FieldMetaData.Builder<_B> _other) {
        _other.name = this.name;
        _other.description = this.description;
        _other.fieldFlags = this.fieldFlags;
        ...
        _other.properties = this.properties;
    }

    public<_B >FieldMetaData.Builder<_B> newCopyBuilder(final _B _parentBuilder) {
        return new FieldMetaData.Builder<_B>(_parentBuilder, this, true);
    }

    public FieldMetaData.Builder<Void> newCopyBuilder() {
        return newCopyBuilder(null);
    }

    public static FieldMetaData.Builder<Void> builder() {
        return new FieldMetaData.Builder<Void>(null, null, false);
    }

    public static<_B >FieldMetaData.Builder<_B> copyOf(final FieldMetaData _other) {
        final FieldMetaData.Builder<_B> _newBuilder = new FieldMetaData.Builder<_B>(null, null, false);
     ...
     *     A builder instance to which the state of this object will be copied.
     */
    public<_B >void copyTo(final FieldMetaData.Builder<_B> _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        ...
        final PropertyTree fieldFlagsPropertyTree = ((_propertyTree == null)?null:_propertyTree.get("fieldFlags"));
        if (((_propertyTreeUse == PropertyTreeUse.INCLUDE)?(fieldFlagsPropertyTree!= null):((fieldFlagsPropertyTree == null)||(!fieldFlagsPropertyTree.isLeaf())))) {
            _other.fieldFlags = this.fieldFlags;
        }
    ...
    public<_B >FieldMetaData.Builder<_B> newCopyBuilder(final _B _parentBuilder, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        return new FieldMetaData.Builder<_B>(_parentBuilder, this, true, _propertyTree, _propertyTreeUse);
    }

    public FieldMetaData.Builder<Void> newCopyBuilder(final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        return newCopyBuilder(null, _propertyTree, _propertyTreeUse);
    }

    public static<_B >FieldMetaData.Builder<_B> copyOf(final FieldMetaData _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        final FieldMetaData.Builder<_B> _newBuilder = new FieldMetaData.Builder<_B>(null, null, false);
        _other.copyTo(_newBuilder, _propertyTree, _propertyTreeUse);
        return _newBuilder;
    }

    public static FieldMetaData.Builder<Void> copyExcept(final FieldMetaData _other, final PropertyTree _propertyTree) {
        return copyOf(_other, _propertyTree, PropertyTreeUse.EXCLUDE);
    }

    public static FieldMetaData.Builder<Void> copyOnly(final FieldMetaData _other, final PropertyTree _propertyTree) {
    ...
    public static class Builder<_B >implements Buildable
    {
        ...
        protected final FieldMetaData _storedValue;
        ...
        private Guid.Builder<FieldMetaData.Builder<_B>> dataSetFieldId;
        private JAXBElement<ListOfKeyValuePair> properties;

        public Builder(final _B _parentBuilder, final FieldMetaData _other, final boolean _copy) {
            ...
            if (_other!= null) {
                if (_copy) {
                    ...
                    this.fieldFlags = _other.fieldFlags;
        ...
        public Builder(final _B _parentBuilder, final FieldMetaData _other, final boolean _copy, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
            this._parentBuilder = _parentBuilder;
            if (_other!= null) {
                if (_copy) {
                    _storedValue = null;
        ...
        protected<_P extends FieldMetaData >_P init(final _P _product) {
            _product.name = this.name;
            _product.description = this.description;
            _product.fieldFlags = this.fieldFlags;
            ...
            _product.properties = this.properties;
            return _product;
        }
         ...
         */
        public FieldMetaData.Builder<_B> withName(final JAXBElement<String> name) {
            this.name = name;
            return this;
        }
         ...
         */
        public FieldMetaData.Builder<_B> withDescription(final JAXBElement<LocalizedText> description) {
            this.description = description;
            return this;
        }

        /**
         * Setzt den neuen Wert der Eigenschaft "fieldFlags" (Vorher zugewiesener Wert wird
         * ersetzt)
         * 
         * @param fieldFlags
         *     Neuer Wert der Eigenschaft "fieldFlags".
         */
        public FieldMetaData.Builder<_B> withFieldFlags(final Integer fieldFlags) {
         ...
         */
        public FieldMetaData.Builder<_B> withBuiltInType(final Short builtInType) {
         ...
         */
        public FieldMetaData.Builder<_B> withDataType(final JAXBElement<NodeId> dataType) {
         ...
         */
        public FieldMetaData.Builder<_B> withValueRank(final Integer valueRank) {
         ...
         */
        public FieldMetaData.Builder<_B> withArrayDimensions(final JAXBElement<ListOfUInt32> arrayDimensions) {
         ...
         */
        public FieldMetaData.Builder<_B> withMaxStringLength(final Long maxStringLength) {
         ...
         */
        public FieldMetaData.Builder<_B> withDataSetFieldId(final Guid dataSetFieldId) {
            this.dataSetFieldId = ((dataSetFieldId == null)?null:new Guid.Builder<FieldMetaData.Builder<_B>>(this, dataSetFieldId, false));
            return this;
        }
         ...
         *     zurück zum aktuellen Builder.
         */
        public Guid.Builder<? extends FieldMetaData.Builder<_B>> withDataSetFieldId() {
            if (this.dataSetFieldId!= null) {
                return this.dataSetFieldId;
            }
            return this.dataSetFieldId = new Guid.Builder<FieldMetaData.Builder<_B>>(this, null, false);
        }

        /**
         * Setzt den neuen Wert der Eigenschaft "properties" (Vorher zugewiesener Wert wird
         * ersetzt)
         * 
         * @param properties
         *     Neuer Wert der Eigenschaft "properties".
         */
        public FieldMetaData.Builder<_B> withProperties(final JAXBElement<ListOfKeyValuePair> properties) {
        ...
        public FieldMetaData build() {
            if (_storedValue == null) {
                return this.init(new FieldMetaData());
            } else {
                return ((FieldMetaData) _storedValue);
            }
        }

        public FieldMetaData.Builder<_B> copyOf(final FieldMetaData _other) {
            _other.copyTo(this);
            return this;
        }

        public FieldMetaData.Builder<_B> copyOf(final FieldMetaData.Builder _other) {
    ...
    public static class Select
        extends FieldMetaData.Selector<FieldMetaData.Select, Void>
    {
        ...
        public static FieldMetaData.Select _root() {
            return new FieldMetaData.Select();
        }
        ...
        extends com.kscs.util.jaxb.Selector<TRoot, TParent>
    {
        ...
        private com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> name = null;
        private com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> description = null;
        private com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> fieldFlags = null;
        private com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> builtInType = null;
        private com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> dataType = null;
        private com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> valueRank = null;
        private com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> arrayDimensions = null;
        private com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> maxStringLength = null;
        private Guid.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> dataSetFieldId = null;
        private com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> properties = null;
        ...
        public Map<String, PropertyTree> buildChildren() {
            ...
            if (this.fieldFlags!= null) {
                products.put("fieldFlags", this.fieldFlags.init());
            }
        ...
        public com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> name() {
            return ((this.name == null)?this.name = new com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>>(this._root, this, "name"):this.name);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> description() {
            return ((this.description == null)?this.description = new com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>>(this._root, this, "description"):this.description);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> fieldFlags() {
            return ((this.fieldFlags == null)?this.fieldFlags = new com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>>(this._root, this, "fieldFlags"):this.fieldFlags);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> builtInType() {
            return ((this.builtInType == null)?this.builtInType = new com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>>(this._root, this, "builtInType"):this.builtInType);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> dataType() {
            return ((this.dataType == null)?this.dataType = new com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>>(this._root, this, "dataType"):this.dataType);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> valueRank() {
            return ((this.valueRank == null)?this.valueRank = new com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>>(this._root, this, "valueRank"):this.valueRank);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> arrayDimensions() {
            return ((this.arrayDimensions == null)?this.arrayDimensions = new com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>>(this._root, this, "arrayDimensions"):this.arrayDimensions);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> maxStringLength() {
            return ((this.maxStringLength == null)?this.maxStringLength = new com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>>(this._root, this, "maxStringLength"):this.maxStringLength);
        }

        public Guid.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> dataSetFieldId() {
            return ((this.dataSetFieldId == null)?this.dataSetFieldId = new Guid.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>>(this._root, this, "dataSetFieldId"):this.dataSetFieldId);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>> properties() {
            return ((this.properties == null)?this.properties = new com.kscs.util.jaxb.Selector<TRoot, FieldMetaData.Selector<TRoot, TParent>>(this._root, this, "properties"):this.properties);
        }
