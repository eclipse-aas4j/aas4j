...
/**
 * <p>Java-Klasse für CreateSubscriptionResponse complex type.
 * 
...
public class CreateSubscriptionResponse {
     ...
     */
    public<_B >void copyTo(final CreateSubscriptionResponse.Builder<_B> _other) {
    ...
    public<_B >CreateSubscriptionResponse.Builder<_B> newCopyBuilder(final _B _parentBuilder) {
        return new CreateSubscriptionResponse.Builder<_B>(_parentBuilder, this, true);
    }

    public CreateSubscriptionResponse.Builder<Void> newCopyBuilder() {
        return newCopyBuilder(null);
    }

    public static CreateSubscriptionResponse.Builder<Void> builder() {
        return new CreateSubscriptionResponse.Builder<Void>(null, null, false);
    }

    public static<_B >CreateSubscriptionResponse.Builder<_B> copyOf(final CreateSubscriptionResponse _other) {
        final CreateSubscriptionResponse.Builder<_B> _newBuilder = new CreateSubscriptionResponse.Builder<_B>(null, null, false);
     ...
     *     A builder instance to which the state of this object will be copied.
     */
    public<_B >void copyTo(final CreateSubscriptionResponse.Builder<_B> _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
    ...
    public<_B >CreateSubscriptionResponse.Builder<_B> newCopyBuilder(final _B _parentBuilder, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        return new CreateSubscriptionResponse.Builder<_B>(_parentBuilder, this, true, _propertyTree, _propertyTreeUse);
    }

    public CreateSubscriptionResponse.Builder<Void> newCopyBuilder(final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        return newCopyBuilder(null, _propertyTree, _propertyTreeUse);
    }

    public static<_B >CreateSubscriptionResponse.Builder<_B> copyOf(final CreateSubscriptionResponse _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        final CreateSubscriptionResponse.Builder<_B> _newBuilder = new CreateSubscriptionResponse.Builder<_B>(null, null, false);
        _other.copyTo(_newBuilder, _propertyTree, _propertyTreeUse);
        return _newBuilder;
    }

    public static CreateSubscriptionResponse.Builder<Void> copyExcept(final CreateSubscriptionResponse _other, final PropertyTree _propertyTree) {
        return copyOf(_other, _propertyTree, PropertyTreeUse.EXCLUDE);
    }

    public static CreateSubscriptionResponse.Builder<Void> copyOnly(final CreateSubscriptionResponse _other, final PropertyTree _propertyTree) {
    ...
    public static class Builder<_B >implements Buildable
    {
        ...
        protected final CreateSubscriptionResponse _storedValue;
        ...
        public Builder(final _B _parentBuilder, final CreateSubscriptionResponse _other, final boolean _copy) {
        ...
        public Builder(final _B _parentBuilder, final CreateSubscriptionResponse _other, final boolean _copy, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
            this._parentBuilder = _parentBuilder;
            if (_other!= null) {
                if (_copy) {
                    _storedValue = null;
        ...
        protected<_P extends CreateSubscriptionResponse >_P init(final _P _product) {
         ...
         */
        public CreateSubscriptionResponse.Builder<_B> withResponseHeader(final JAXBElement<ResponseHeader> responseHeader) {
         ...
         */
        public CreateSubscriptionResponse.Builder<_B> withSubscriptionId(final Long subscriptionId) {
         ...
         */
        public CreateSubscriptionResponse.Builder<_B> withRevisedPublishingInterval(final Double revisedPublishingInterval) {
         ...
         */
        public CreateSubscriptionResponse.Builder<_B> withRevisedLifetimeCount(final Long revisedLifetimeCount) {
         ...
         */
        public CreateSubscriptionResponse.Builder<_B> withRevisedMaxKeepAliveCount(final Long revisedMaxKeepAliveCount) {
        ...
        public CreateSubscriptionResponse build() {
            if (_storedValue == null) {
                return this.init(new CreateSubscriptionResponse());
            } else {
                return ((CreateSubscriptionResponse) _storedValue);
            }
        }

        public CreateSubscriptionResponse.Builder<_B> copyOf(final CreateSubscriptionResponse _other) {
            _other.copyTo(this);
            return this;
        }

        public CreateSubscriptionResponse.Builder<_B> copyOf(final CreateSubscriptionResponse.Builder _other) {
    ...
    public static class Select
        extends CreateSubscriptionResponse.Selector<CreateSubscriptionResponse.Select, Void>
    {
        ...
        public static CreateSubscriptionResponse.Select _root() {
            return new CreateSubscriptionResponse.Select();
        }
        ...
        extends com.kscs.util.jaxb.Selector<TRoot, TParent>
    {
        ...
        private com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>> responseHeader = null;
        private com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>> subscriptionId = null;
        private com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>> revisedPublishingInterval = null;
        private com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>> revisedLifetimeCount = null;
        private com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>> revisedMaxKeepAliveCount = null;
        ...
        public com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>> responseHeader() {
            return ((this.responseHeader == null)?this.responseHeader = new com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>>(this._root, this, "responseHeader"):this.responseHeader);
        }

        public com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>> subscriptionId() {
            return ((this.subscriptionId == null)?this.subscriptionId = new com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>>(this._root, this, "subscriptionId"):this.subscriptionId);
        }

        public com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>> revisedPublishingInterval() {
            return ((this.revisedPublishingInterval == null)?this.revisedPublishingInterval = new com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>>(this._root, this, "revisedPublishingInterval"):this.revisedPublishingInterval);
        }

        public com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>> revisedLifetimeCount() {
            return ((this.revisedLifetimeCount == null)?this.revisedLifetimeCount = new com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>>(this._root, this, "revisedLifetimeCount"):this.revisedLifetimeCount);
        }

        public com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>> revisedMaxKeepAliveCount() {
            return ((this.revisedMaxKeepAliveCount == null)?this.revisedMaxKeepAliveCount = new com.kscs.util.jaxb.Selector<TRoot, CreateSubscriptionResponse.Selector<TRoot, TParent>>(this._root, this, "revisedMaxKeepAliveCount"):this.revisedMaxKeepAliveCount);
        }
