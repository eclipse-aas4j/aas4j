...
/**
 * <p>Java-Klasse für WriteResponse complex type.
 * 
...
public class WriteResponse {
     ...
     */
    public<_B >void copyTo(final WriteResponse.Builder<_B> _other) {
        _other.responseHeader = this.responseHeader;
        _other.results = this.results;
        _other.diagnosticInfos = this.diagnosticInfos;
    }

    public<_B >WriteResponse.Builder<_B> newCopyBuilder(final _B _parentBuilder) {
        return new WriteResponse.Builder<_B>(_parentBuilder, this, true);
    }

    public WriteResponse.Builder<Void> newCopyBuilder() {
        return newCopyBuilder(null);
    }

    public static WriteResponse.Builder<Void> builder() {
        return new WriteResponse.Builder<Void>(null, null, false);
    }

    public static<_B >WriteResponse.Builder<_B> copyOf(final WriteResponse _other) {
        final WriteResponse.Builder<_B> _newBuilder = new WriteResponse.Builder<_B>(null, null, false);
     ...
     *     A builder instance to which the state of this object will be copied.
     */
    public<_B >void copyTo(final WriteResponse.Builder<_B> _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
    ...
    public<_B >WriteResponse.Builder<_B> newCopyBuilder(final _B _parentBuilder, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        return new WriteResponse.Builder<_B>(_parentBuilder, this, true, _propertyTree, _propertyTreeUse);
    }

    public WriteResponse.Builder<Void> newCopyBuilder(final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        return newCopyBuilder(null, _propertyTree, _propertyTreeUse);
    }

    public static<_B >WriteResponse.Builder<_B> copyOf(final WriteResponse _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        final WriteResponse.Builder<_B> _newBuilder = new WriteResponse.Builder<_B>(null, null, false);
        _other.copyTo(_newBuilder, _propertyTree, _propertyTreeUse);
        return _newBuilder;
    }

    public static WriteResponse.Builder<Void> copyExcept(final WriteResponse _other, final PropertyTree _propertyTree) {
        return copyOf(_other, _propertyTree, PropertyTreeUse.EXCLUDE);
    }

    public static WriteResponse.Builder<Void> copyOnly(final WriteResponse _other, final PropertyTree _propertyTree) {
    ...
    public static class Builder<_B >implements Buildable
    {
        ...
        protected final WriteResponse _storedValue;
        ...
        public Builder(final _B _parentBuilder, final WriteResponse _other, final boolean _copy) {
        ...
        public Builder(final _B _parentBuilder, final WriteResponse _other, final boolean _copy, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
            this._parentBuilder = _parentBuilder;
            if (_other!= null) {
                if (_copy) {
                    _storedValue = null;
        ...
        protected<_P extends WriteResponse >_P init(final _P _product) {
         ...
         */
        public WriteResponse.Builder<_B> withResponseHeader(final JAXBElement<ResponseHeader> responseHeader) {
         ...
         */
        public WriteResponse.Builder<_B> withResults(final JAXBElement<ListOfStatusCode> results) {
         ...
         */
        public WriteResponse.Builder<_B> withDiagnosticInfos(final JAXBElement<ListOfDiagnosticInfo> diagnosticInfos) {
        ...
        public WriteResponse build() {
            if (_storedValue == null) {
                return this.init(new WriteResponse());
            } else {
                return ((WriteResponse) _storedValue);
            }
        }

        public WriteResponse.Builder<_B> copyOf(final WriteResponse _other) {
            _other.copyTo(this);
            return this;
        }

        public WriteResponse.Builder<_B> copyOf(final WriteResponse.Builder _other) {
    ...
    public static class Select
        extends WriteResponse.Selector<WriteResponse.Select, Void>
    {
        ...
        public static WriteResponse.Select _root() {
            return new WriteResponse.Select();
        }
        ...
        extends com.kscs.util.jaxb.Selector<TRoot, TParent>
    {
        ...
        private com.kscs.util.jaxb.Selector<TRoot, WriteResponse.Selector<TRoot, TParent>> responseHeader = null;
        private com.kscs.util.jaxb.Selector<TRoot, WriteResponse.Selector<TRoot, TParent>> results = null;
        private com.kscs.util.jaxb.Selector<TRoot, WriteResponse.Selector<TRoot, TParent>> diagnosticInfos = null;
        ...
        public com.kscs.util.jaxb.Selector<TRoot, WriteResponse.Selector<TRoot, TParent>> responseHeader() {
            return ((this.responseHeader == null)?this.responseHeader = new com.kscs.util.jaxb.Selector<TRoot, WriteResponse.Selector<TRoot, TParent>>(this._root, this, "responseHeader"):this.responseHeader);
        }

        public com.kscs.util.jaxb.Selector<TRoot, WriteResponse.Selector<TRoot, TParent>> results() {
            return ((this.results == null)?this.results = new com.kscs.util.jaxb.Selector<TRoot, WriteResponse.Selector<TRoot, TParent>>(this._root, this, "results"):this.results);
        }

        public com.kscs.util.jaxb.Selector<TRoot, WriteResponse.Selector<TRoot, TParent>> diagnosticInfos() {
            return ((this.diagnosticInfos == null)?this.diagnosticInfos = new com.kscs.util.jaxb.Selector<TRoot, WriteResponse.Selector<TRoot, TParent>>(this._root, this, "diagnosticInfos"):this.diagnosticInfos);
        }
